...
- (void)viewDidLoad2 {
    ...
    UIView *subView = [[UIView alloc] initWithFrame:CGRectMake(15, 15, myView.frame.size.width -30, myView.frame.size.height -30)];
    [subView setBackgroundColor:[UIColor blackColor]];
    [myView addSubview:subView];
    
    UIView *subView2 = [[UIView alloc] initWithFrame:CGRectMake(15, 15, subView.frame.size.width -30, subView.frame.size.height -30)];
...
//    
    UIView *myView2 = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height)];
    [myView2 setBackgroundColor :[UIColor greenColor]];
    [self.view addSubview:myView2];
    
    UIView *myViewSub = [[UIView alloc] initWithFrame:CGRectMake(0, 64, myView2.frame.size.width, myView2.frame.size.height -64 -48)];
